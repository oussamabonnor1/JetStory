...
public class MainStoryActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    FragementActionStoryList action = new FragementActionStoryList();
                    return action;
                case 1:
                    FragementActionStoryList romance = new FragementActionStoryList();
                    return romance;
                case 2:
                    FragementActionStoryList comedy = new FragementActionStoryList();
                    return comedy;
                case 3:
                    FragementActionStoryList moral = new FragementActionStoryList();
                    return moral;
                default:
                    return null;
            }
